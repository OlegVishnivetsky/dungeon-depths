...
public class AStarTest : MonoBehaviour
{
    ...
    private void StaticEventHandler_OnRoomChanged(RoomChangedEventArgs roomChangedEventArgs)
    {
        ...
        fronTilemap = instantiatedRoom.transform.Find("Grid/Tilemap4_Front").GetComponent<Tilemap>();
    ...
    {
        Transform tilemapCloneTransfrom = instantiatedRoom.transform.Find("Grid/Tilemap4_Front(Clone)");

        if (tilemapCloneTransfrom == null)
        {
            pathTilemap = Instantiate(fronTilemap, grid.transform);
